...
return array_merge($extra, [
    ...
    '系统用户管理'            => 'Users',
    '系统配置'                 =>'System Config',
    '权限管理'=>'Authority Manage',
    '系统权限管理'=>'System Authority Manage',
    '系统日志管理'=>'System Log Manage',
    '系统菜单管理'=>'System Menu Manage',
    '系统管理'=>'System Manage',
    '回 收 站'=>'Recycle Bin',
    '设备管理'=>'Equipment Manage',
    '设备账号管理'=>'Equipment User Bind',
    '任务列表'=>'Task List',
    '保存数据'=>'Save',
    '取消编辑'=>'Cancel',
    '确定要取消编辑吗？'=>'Are you sure to cancel?',
    '删 除'=>'delete',
    '编 辑'=>'edit',
    '操作面板'=>'Edit tool',
    '添 加'=>'add',

    '充值账号'=>'Recharge account',
    '登录密码'=>'Login password',
    '充值ID'=>'Recharge ID',
    '充值密码'=>'Recharge password',
    '启动状态'=>'Initiate state',
    '设备状态'=>'Equipment state',
    '设备执行状态'=>'Running state',

    '设备账号绑定'=>'Equipment user bind',
    '添加绑定'=>'Add bind',
    '设备ID'=>'Equipment id',
    '用户'=>'User',
    '昵称'=>'Nickname',
    ...
    '导入任务'=>'Import task',
    '搜 索'=>'search',
    '确定要永久删除吗？'=>'Permanent deletion?',
    '确认'=>'sure',
    '取消'=>'cancel',
    '确定要退出登录吗？'=>'Are you sure logout',
    '备注'=>'Remark',

    '登录账号不能为空!'=>'Login account cannot be empty!',
    '账号不能少于4位字符!'=>'Account number must not be less than 4 characters!',
    '登录密码不能为空!'=>'The login password cannot be empty!',
    '密码不能少于4位字符!'=>'Password must not be less than 4 characters!',
    '图形验证码不能为空!'=>'Graphic verification code cannot be empty!',
    '图形验证标识不能为空!'=>'The graphic validation ID cannot be empty!',
    '清空数据'=>'clear data',
    '导 出'=>'export',
    '已激活'=>'ON',
    '已禁用'=>'OFF',
    '创建用户'=>'Creater',
    '批量禁用'=>'Disable in bulk'
]);